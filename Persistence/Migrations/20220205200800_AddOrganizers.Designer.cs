...
partial class AddOrganizers
{
    protected override void BuildTargetModel(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity("Meetups.Persistence.Entities.Organizer", organizerEntity =>
        {
            organizerEntity.HasBaseType("Meetups.Persistence.Entities.User");
        ...
        {
            meetupEntity
                .HasOne("Meetups.Persistence.Entities.Organizer", "Organizer")
